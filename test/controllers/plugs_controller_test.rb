...
class PlugsControllerTest < ActionController::TestCase
  ...
  test "should create plug" do
    assert_difference('Plug.count') do
      post :create, plug: { bluetooth_address: @plug.bluetooth_address, mac_address: @plug.mac_address, plug_name: @plug.plug_name, user_id: @plug.user_id }
    end
  ...
  test "should update plug" do
    patch :update, id: @plug, plug: { bluetooth_address: @plug.bluetooth_address, mac_address: @plug.mac_address, plug_name: @plug.plug_name, user_id: @plug.user_id }
    assert_redirected_to plug_path(assigns(:plug))
  end
